...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString, int? selectedYear)
        {
            ...
            // Use LINQ to get list of unique release years.
            ...
            // Filter by the selected year or newer if the user picked one
            ...
            var movieGenreVM = new MovieGenreViewModel
            {
                ...
                Years = new SelectList(await yearQuery.Distinct().ToListAsync()), // Populate the year dropdown
